...
export default function ExpensesScreen() {
 ...
 // fetch data of expense from database......................................................   
    const fetchExpenses = async () => {
        try {
            const querySnapshot = await getDocs(collection(db, "OrganizationalExpenses"));
  ...
  // retunr part of the page......................................................
    ...
    return (
        ...
        {/* Header Image */}
            <Image
                source={require("../../../../assets/images/OrgExpenseimage.png")}
                style={{ width: "100%", height: 330, resizeMode: "cover", borderRadius: 5, marginBottom: 10 }}
                />
            <Text style={styles.title}>ORGANIZATIONAL {"\n"}           EXPENSES</Text>
